This repository contains sample codes and scripts for combining Gaussian process regression (GPR) with QM/MM in CHARMM through pyCHARMM. 

Currently, a minimal but complete example - based on GPR with derivative observations (GPRwDO) using Behler-Parrinello (BP) descriptors -
