...
Currently, two minimal but complete examples - based on energy-only GPR (GPR) and GPR with derivative observations (GPRwDO) both using the Behler-Parrinello (BP) 
descriptors - are included, enabling GPR- and GPRwDO-corrected QM/MM potential energy calculations for the Menshutkin reaction. 
...
Reference:  
“Enhancing Gaussian Process Regression-Accelerated QM/MM Free Energy Simulations Using Atomic Environment Descriptors,” Snyder, R.; 
Li, D.; Ho, Tinh; Kim, B.; Qazi, H.; Pan, X.; Shao, Y.; Pu, J. **2025**, submitted (preprint: *ChemRxiv* [DOI:10.26434/chemrxiv-2025-hg8n7](https://doi.org/10.26434/chemrxiv-2025-hg8n7)).
